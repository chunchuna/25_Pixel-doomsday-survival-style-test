...
export class UIBubble {
    ...
    public enableTypewriter(speed: number = 50): UIBubble {
        ...
        try {
            const delayTimer = Unreal__.runtime.objects.C3Ctimer.createInstance("Other", -100, -100);
    ...
    private createHtmlElement(): void {
        try {
            ...
            this.htmlElement = Unreal__.runtime.objects.HTML_c3.createInstance(
                this.layer,
                this._x,
                this._y
            );
    ...
    private startTypewriterEffect(): void {
        ...
        try {
            ...
            this.typewriterTimer = Unreal__.runtime.objects.C3Ctimer.createInstance("Other", -100, -100);
    ...
    private startAutoDestroy(): void {
        ...
        try {
            ...
            this.destroyTimer = Unreal__.runtime.objects.C3Ctimer.createInstance("Other", -100, -100);
